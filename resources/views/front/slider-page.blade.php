<section id="home">
<style>
/* Hide slider navigation and tighten text on mobile for slider-page */
@media (max-width: 768px) {
    .tparrows,
    .tp-bullets { display: none !important; }
    .homer-service-heading { font-size: 30px !important; line-height: 1.15 !important; letter-spacing: 0 !important; }
    .homer-service-pra { font-size: 14px !important; line-height: 1.3 !important; margin-top: 8px !important; }
}
</style>
                ...
                <div id="rev_slider_15_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.4.7">
                    <ul>
                        ...
                        <li data-index="rs-25" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                            ...
                            <!-- MAIN IMAGE -->
                            <img src="{{asset('uploads/bg.png')}}" alt="" data-bgposition="center center"
                            ...
                            <div class="tp-caption  homer-service-heading" id="slide-25-layer-1" data-x="['center','center','center','center']"
                                ...
                                <span class="secondary-font theme-color" style="font-weight: 700;"></span> Marketing Communications </div>
