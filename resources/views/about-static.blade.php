<div class="brook-progress-charts-area pt--100 pb--100 pt_md--80 pt_sm--60">
                <div class="container-fluid">
                    <div class="row align-items-center plr--190 plr_lg--50 plr_md--50 plr_sm--50">
                        <div class="col-lg-5 col-md-12 col-12">
                            <div class="thumb wow move-up animate">
                                <img style="width: 100%;" src="{{asset('theme/img/Music/Types-of-track.jpg')}}" alt="brook multipurpose">
                            </div>
                        </div>
                        <div class="col-lg-7 col-md-12 col-12 pl--110">
                           {{--  --}}
