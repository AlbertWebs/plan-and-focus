...
<div class="max-w-4xl">
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900 mb-2">Edit Client</h1>
        <p class="text-gray-600">Update client information and logo</p>
    </div>

    <form action="{{ route('admin.clients.update', $client) }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-xl shadow-lg p-6" x-data="{ imagePreview: null, useUpload: 'keep' }">
        @csrf
        @method('PUT')
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                @if($client->logo)
                    <div class="mb-4">
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg inline-block">
                            <img src="{{ asset('uploads/clients/' . $client->logo) }}" alt="{{ $client->name }}" class="h-24 w-auto object-contain" onerror="this.style.display='none'">
                        </div>
                    </div>
                @endif
                ...
                <div class="flex items-center space-x-4 mb-4">
                    <label class="flex items-center">
                        ...
                        <span class="ml-2 text-sm text-gray-700">Upload New Logo</span>
                    </label>
                    <label class="flex items-center">
                    ...
                    <label class="flex items-center">
                        <input type="radio" name="logo_type" value="keep" x-model="useUpload" class="h-4 w-4 text-indigo-600 focus:ring-indigo-500">
                ...
                <div x-show="useUpload === 'upload'" x-cloak>
                    ...
                    <div x-show="imagePreview" class="mt-4" x-cloak>
                        <p class="text-sm text-gray-600 mb-2 text-center">New Logo Preview:</p>
                ...
                <div x-show="useUpload === 'path'" x-cloak>
                    <input type="text" name="logo_path" id="logo_path" value="{{ old('logo_path', $client->logo) }}"
            ...
            <div>
                ...
                <input type="number" name="order" id="order" value="{{ old('order', $client->order) }}" min="0"
