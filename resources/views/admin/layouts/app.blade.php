    ...
    <div x-data="{ sidebarOpen: false }" class="min-h-screen">
        ...
        >
            ...
            <nav class="mt-8 px-3">
                ...
                @if(config('app.maintenance.secret'))
                <a href="{{ route('admin.maintenance.down', ['token' => config('app.maintenance.secret')]) }}" target="_blank" rel="noopener noreferrer" class="flex items-center px-4 py-3 mb-2 text-indigo-100 hover:bg-amber-600/30 hover:text-white rounded-xl transition-all duration-200" title="Put site in maintenance mode (opens in new tab)">
                    <div class="flex-shrink-0 w-10 h-10 rounded-lg bg-indigo-600/30 flex items-center justify-center mr-3">
                        <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
