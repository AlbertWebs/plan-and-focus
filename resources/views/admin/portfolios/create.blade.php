...
<div class="max-w-4xl">
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900 mb-2">Create New Portfolio</h1>
        <p class="text-gray-600">Add a new portfolio item to showcase your work</p>
    </div>

    <form action="{{ route('admin.portfolios.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-xl shadow-lg p-6" x-data="{ imagePreview: null, useUpload: 'upload' }">
        @csrf
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="6"
                    ...
                    placeholder="Enter portfolio description">{{ old('description') }}</textarea>
                @error('description')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
