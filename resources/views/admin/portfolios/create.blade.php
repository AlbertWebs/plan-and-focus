...
@section('content')
<div class="max-w-4xl">
    <h1 class="text-2xl font-bold text-gray-900 mb-6">Create New Portfolio</h1>

    <form action="{{ route('admin.portfolios.store') }}" method="POST" class="bg-white shadow rounded-lg p-6">
        @csrf
